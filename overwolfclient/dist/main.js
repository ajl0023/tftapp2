...
function registerEvents() {
  ...
  function postData(events) {
    if (
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post("http://localhost:7000/api/match-history", {
